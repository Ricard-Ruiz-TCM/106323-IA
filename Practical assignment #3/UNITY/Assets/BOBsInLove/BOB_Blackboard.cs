...
public class BOB_Blackboard : DynamicBlackboard {
    ...
    public void DeActivateRing() {
        FindChildWithTag(gameObject, "RING").SetActive(false);
    }

    public void DeActivateNecklace() {
        FindChildWithTag(gameObject, "NECKLACE").SetActive(false);
    }
